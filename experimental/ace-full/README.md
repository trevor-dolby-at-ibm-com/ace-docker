...
```
docker build -t ace-full:13.0.1.0-ubuntu -f Dockerfile.ubuntu .
```
in this directory.
...
docker run -e LICENSE=accept -e DISPLAY --network=host -v $HOME/.Xauthority:/home/aceuser/.Xauthority --rm -ti ace-full:13.0.1.0-ubuntu
```
